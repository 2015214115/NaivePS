    ...
    ui(new Ui::MainWindow)
{
    ...
    on_actionChinese_triggered(); //中文界面
...
void MainWindow::createToolBar()
{
    ...
    ui->toolBar->addAction(screenShot);
}
...
void MainWindow::startCatureImage()
{
    // 点击截图按钮开始截图;
...
void MainWindow::setActionStatus(bool status)
{
    ...
    //
    ui->actionRGB2Cmyk->setEnabled(status);
    ui->actionRGB2HSL->setEnabled(status);
    ui->actionRGB2HSV->setEnabled(status);
}
...
void MainWindow::on_actionOpen_triggered()
{
    ...
    if (!imagePath.isEmpty())
    {
        ...
        // settings
        this->setWindowTitle(info->fileName() + " - NaivePS");
...
void MainWindow::on_actionHistogram_triggered()
{
    ...
    hstgrmDialog->setWindowTitle("Histogram - NaivePS");
...
{
    QMessageBox message(QMessageBox::NoIcon, tr(WINDOW_ABOUT), "<h1>Naive!</h1>"
                                                               "Powered By Qt 5.10.1.");
